  ...
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      <div className="relative h-36 w-36">
        <svg className="h-36 w-36 -rotate-90" viewBox="0 0 120 120" role="progressbar" aria-valuenow={remaining} aria-valuemin={0} aria-valuemax={seconds} aria-label={`${label ?? 'Minuteur'} : ${formatTime(remaining)} restantes`}>
